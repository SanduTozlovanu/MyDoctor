...
namespace MyDocAppointment.API.Validations
{
    ...
    {
        private const string WRONG_NAME_LENGTH_ERROR = "The name should be between 5 and 100 characters";
        private const string DESCRIPTION_LENGTH_ERROR = "The description should be between 10 and 400 characters";
